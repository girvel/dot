...
return factoring.from_atlas(
  "assets/sprites/atlases/solids.png", config.cell_size,
  {
    ...
    "slope_7",   "slope_6",   "stool",    "trunk_5",  "trunk_6",    "rock_1",     "rock_2",     "table_1",
    "slope_8",   "slope_9",   "slope_10", "statue_1", "statue_2",   "statue_3",   "statue_4",   "table_2",
    "slope_11",  "slope_12",  false,      false,      "table_5",    "table_6",    "table_7",    "table_3",
